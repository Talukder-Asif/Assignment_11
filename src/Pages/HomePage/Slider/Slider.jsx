    ...
    <div style={{backgroundImage: 'url(https://i.ibb.co/rkqPmmy/Slider.jpg)'}} className="bg-cover bg-no-repeat py-10 bg-right-bottom ">
      ...
      >
          ...
          <div  className=" bg-transparent top-0 left-0 w-full relative">
                ...
                <Link to={'/foodItems'} ><button className="mt-5 border-2 border-[#eb0029] text-white bg-[#eb0029] hover:bg-white hover:text-[#eb0029] font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Food Items</button></Link>
                
                </div>

                <div className="md:w-5/12 lg:w-6/12">
                {/* Main Img */}
                    <img src="https://themeholy.com/wordpress/pizzan/wp-content/uploads/2023/06/about_1.png" alt="" />
                </div>
                </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div  className=" bg-transparent top-0 left-0 w-full relative">
                ...
                GET BEST QUALITY FOOD FROM US                </h2>
                <p className="text-white ">Experimentation in the kitchen and focus on excellence are among our main driving forces in cooking.</p>
